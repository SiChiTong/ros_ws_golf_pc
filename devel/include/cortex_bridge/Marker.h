// Generated by gencpp from file cortex_bridge/Marker.msg
// DO NOT EDIT!


#ifndef CORTEX_BRIDGE_MESSAGE_MARKER_H
#define CORTEX_BRIDGE_MESSAGE_MARKER_H
...
struct Marker_
{
  ...
  typedef boost::shared_ptr< ::cortex_bridge::Marker_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::cortex_bridge::Marker_<ContainerAllocator> const> ConstPtr;

}; // struct Marker_

typedef ::cortex_bridge::Marker_<std::allocator<void> > Marker;

typedef boost::shared_ptr< ::cortex_bridge::Marker > MarkerPtr;
typedef boost::shared_ptr< ::cortex_bridge::Marker const> MarkerConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::cortex_bridge::Marker_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::cortex_bridge::Marker_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::cortex_bridge::Marker_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::cortex_bridge::Marker_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::cortex_bridge::Marker_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::cortex_bridge::Marker_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cortex_bridge::Marker_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cortex_bridge::Marker_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::cortex_bridge::Marker_<ContainerAllocator> >
{
  ...
  static const char* value(const ::cortex_bridge::Marker_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xda6f93747c24b19aULL;
  static const uint64_t static_value2 = 0x71932ae4b040f489ULL;
};

template<class ContainerAllocator>
struct DataType< ::cortex_bridge::Marker_<ContainerAllocator> >
{
  static const char* value()
  {
    return "cortex_bridge/Marker";
  }
...
template<class ContainerAllocator>
struct Definition< ::cortex_bridge::Marker_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::cortex_bridge::Marker_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::cortex_bridge::Marker_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::cortex_bridge::Marker_<ContainerAllocator>& v)
  {
...
#endif // CORTEX_BRIDGE_MESSAGE_MARKER_H
