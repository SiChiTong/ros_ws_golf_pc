...
class Rt1Sensor {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('handle')) {
        ...
        this.handle = new geometry_msgs.msg.Wrench();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = geometry_msgs.msg.Wrench.serialize(obj.handle, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Rt1Sensor(null);
    // Deserialize message field [accel]
    data.accel = geometry_msgs.msg.Accel.deserialize(buffer, bufferOffset);
    // Deserialize message field [handle]
    data.handle = geometry_msgs.msg.Wrench.deserialize(buffer, bufferOffset);
  ...
  static datatype() {
    ...
    return 'ros_start/Rt1Sensor';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'c7cab7112c2414c7aa38d0d3d47179d8';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Rt1Sensor(null);
    ...
    if (msg.handle !== undefined) {
      resolved.handle = geometry_msgs.msg.Wrench.Resolve(msg.handle)
    }
    else {
      resolved.handle = new geometry_msgs.msg.Wrench()
    }
